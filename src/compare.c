...
// copy from utils.c line97-118
static void sorta_shuffle(sortable_bbox *arr, size_t n, size_t size, size_t sections)
{
	size_t i;
...
static void shuffle(sortable_bbox *arr, size_t n, size_t size)
{
	size_t i;
